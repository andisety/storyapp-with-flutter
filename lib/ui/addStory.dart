...
class _AddStoryPageState extends State<AddStoryPage> {
  ...
  bool isValidImageFile(File file) {
    ...
    if (file.lengthSync() > maxSizeInBytes) {
      _showToast("gambar terlalu besar");
      return false;
    }
  ...
  void _postStory() async {
    ...
    if (_descriptionController.text.isNotEmpty) {
      try {
        ...
        final lat = 0.0; // Replace with actual latitude
        final lon = 0.0; // Replace with actual longitude
        ...
        final story = StoryModel(
            description: description, photo: imagepicker!, lat: lat, lon: lon);
      ...
      _showToast("Deskripsi harus isi");
      Navigator.pop(context);
    }
  }
